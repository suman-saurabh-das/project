...
const Sidebar = () => {
    ...
    return (
        // Sidebar Container
        // <div className='fixed top-0 bottom-0 lg:left-0 bg-[#01010180] w-full z-50'>
        <div className={`bg-white duration-500 sm:hidden overflow-y-auto p-4 fixed top-0 bottom-0 lg:left-0 w-full z-50 ${isSidebarVisible}`}>
